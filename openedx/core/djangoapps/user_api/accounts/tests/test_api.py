...
def test_create_account_duplicate_email(django_db_use_migrations):
    ...
    migrations are being used. Since pytest fixtures don't play nice with
    TestCase objects this is a function and doesn't get to use assertRaises.
    """
    password = 'legit'
    ...
    if django_db_use_migrations:
        ...
        assert success, 'Migrations are being used, but creating an account with duplicate email succeeded!'
